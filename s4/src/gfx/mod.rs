...
pub fn load(kind: Kind) -> io::Result<Resource> {

    let archive = Archive::new("c:\\Program Files (x86)\\GOG Galaxy\\Games\\Settlers 4 Gold\\gfx.lib").unwrap();
